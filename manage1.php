    ...
    <ul class="navbar-nav mr-auto">
		...
		<li class="nav-item">
			<a class="nav-link" href="main.php">Home</font></a></li><?php
						...
						<li class="active"><a class="nav-link" href="manage1.php" style="font-size:17px">Manage Request(s)</a></li>
...
<?php
	  ...
	  for ($i=1;$i<=$records[0][0];$i++){
		...
		echo "<tr>
		  ...
		  <td>".$now."</td>
		  <td style='text-align:center !important'>" ?><a href="manage1.php?ida=<?php echo $records[$i]["id"]; ?>"><span class="fas fa-user-tag"></span></a></td>
		  <td style='text-align:center !important'>
			<a href="manage1.php?upda=<?php echo $records[$i]["id"]; ?>">
